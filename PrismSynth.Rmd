...
barplot(thresh.count$thresh, names=thresh.count$Group.1, ylab="Count (days)", xlab="Year")
...
barplot(num.long.yr$runs, names=num.long.yr$Group.1, ylab="No. Long Freeze (>5 days)", xlab="Year")
